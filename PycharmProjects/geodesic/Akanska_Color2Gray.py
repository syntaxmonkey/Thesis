...
def main(col_name):
	...
	input_path = os.path.join(col_name )
	output_path = os.path.join( col_name + '_bw' )
...
if __name__ == '__main__':
	image1 = '/Users/hengsun/Downloads/larry-ferreira-9Rs5eop48KQ-unsplash.png'
